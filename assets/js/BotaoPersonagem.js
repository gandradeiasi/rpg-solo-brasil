class BotaoPersonagem {
    ...
    static oficios = [
        'estudante', 'cultista', 'monge/monja', 'sacerdote/sacerdotisa', 'guerreiro(a)', 'marechal', 'general', 'soldado(a)',
        'cabo', 'mercador(a)', 'cozinheiro(a)', 'artesão/artesã', 'arquiteto(a)', 'pintor(a)', 'engenheiro(a)', 'caçador(a)',
        'inventor(a)', 'médico(a)', 'curandeiro(a)', 'guarda', 'nobre', 'governante', 'tenente', 'cidadão/cidadã', 'coronel',
        'fazendeiro(a)', 'alquimista', 'professor(a)', 'pirata', 'contrabandista', 'mago(a)', 'marceneiro(a)', 'capitão/capitã',
        ...
        'hebolario(a)', 'lutador(a)', 'gladiador(a)', 'mestre(a)', 'ator/atriz', 'musicista', 'joalheiro(a)', 'minerador(a)',
    ...
    static silabas = [
        '-', 'an', 'ra', 'ga', 'be', 'tor', 'van', 'lia', 'ti', 'to', 'fri', 'dei', 'on',
        ...
        'cho', 'que', 'is', 'so', 've', 'ser', 'le', 'gal', 'w', 'ha', 'he', 'hi', 'ho',
        'qual', 'eh', 'sen', 'do', 'vi', 'nao', 'sei', 'te', 'lu', 'mas', 'dal', 'fa',
        'ceu', 'ou', 'eis', 'ques', 'tao', 'pal', 'des', 'gar', 'pro', 'cras', 'nar',
        'pa', 'pi', 'tan', 'gu', 'vo', 'ro', 'ber', 'ju', 'lio', 'gil', 'son', 'ge', 'cis', 'mar', 'cus',
        'bri', 'el', 'si', 'bio', 'por', 'chat', 'chet', 'bol', 'mi', 'cha', 'gui', 'lher', 'tro', 'va', 'dor',
        'ben', 'ja', 'min', 'klin'
    ]
